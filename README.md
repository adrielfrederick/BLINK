...
```console
python run_blink.py -i --fast
```

To run BLINK with saved FAISS index, run:
```console
python run_blink.py -i --faiss_index flat --index_path models/faiss_flat_index.pkl
```
or 
```console
python run_blink.py -i --faiss_index hnsw --index_path models/faiss_hnsw_index.pkl
```
